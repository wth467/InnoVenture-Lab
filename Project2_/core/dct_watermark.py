...
class DCTWatermark:
    def __init__(self, password=0, block_size=8, alpha=0.05):
        """
        基于DCT的数字水印系统
    ...
    def extract(self, img, wm_shape, estimate_attack=False):
        ...
        for pos in positions:
            ...
            # 提取水印位
            avg_neighbor = (dct_block[u-1, v] + dct_block[u+1, v] + 
                           dct_block[u, v-1] + dct_block[u, v+1]) / 4
            if dct_block[u, v] > avg_neighbor:
